...
export type NavRequest = { type: 'init'; pack: ArrayBuffer } | { type: 'path'; id: number; from: NavPoint; to: NavPoint };
...
export class PathFinder {
    ...
    findPath(fromRaw: NavPoint, toRaw: NavPoint, maxExpansions: number = MAX_EXPANSIONS): PathOutcome {
